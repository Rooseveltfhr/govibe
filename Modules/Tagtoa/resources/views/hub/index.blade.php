...
<div class="grid g3">
    @foreach([
        ...
        ['cards','Cartes TAGTOA','fa-credit-card','Carte NFC prépayée closed-loop : émettre, recharger, payer partout.'],
        ...
        ['qr','QR & Partage','fa-qrcode','QR codes de vos pages publiques + affiches imprimables.'],
        ['analytics','Analytics','fa-chart-line','Revenus, ventes, visites et top produits en temps réel.'],
        ['customers','Clients (CRM)','fa-users','Base clients agrégée de tous vos modules.'],
