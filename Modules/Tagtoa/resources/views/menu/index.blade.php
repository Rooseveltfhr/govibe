        ...
        @foreach($menus as $m)
            ...
            <div class="card">
                ...
                <div class="row" style="margin-top:14px;gap:8px">
                    ...
                    @if(in_array('delivery', \Modules\Tagtoa\App\Models\Menu\Order::serviceTypesFor($m->service_types), true))
                        <a href="{{ route('tagtoa.menu.dashboard.delivery',$m->id) }}" class="btn btn-o btn-sm" style="flex:0"><i class="fa-solid fa-motorcycle"></i> {{ __('Livraison') }}</a>
                    @endif
