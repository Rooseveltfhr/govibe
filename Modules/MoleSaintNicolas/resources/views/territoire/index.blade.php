...
@section('content')
    <div class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <h1 class="mt-2 text-3xl font-bold text-msn-ink-900 sm:text-4xl">
        ...
        <h2 class="mt-10 text-xl font-bold text-msn-ink-900">Communes</h2>
        <div class="mt-4 grid gap-4 sm:grid-cols-2">
            ...
            @empty
                <p class="text-msn-ink-700">[Information à compléter — aucune commune enregistrée]</p>
            @endforelse
        </div>
    </div>
@endsection
