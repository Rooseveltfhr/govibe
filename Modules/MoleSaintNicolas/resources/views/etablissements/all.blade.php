...
@section('content')
    <div class="mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold text-msn-sand-100 sm:text-4xl">Établissements</h1>
        <p class="mt-2 text-msn-sand-200">Hôtels, restaurants et bars à Môle-Saint-Nicolas.</p>

        <div class="mt-6 flex gap-3 text-sm">
            <a href="{{ route('hotels.index') }}" class="rounded-full border border-msn-sea-700 px-4 py-1.5 font-semibold text-msn-sand-100 hover:bg-msn-sea-900">Hôtels</a>
            <a href="{{ route('restaurants.index') }}" class="rounded-full border border-msn-sea-700 px-4 py-1.5 font-semibold text-msn-sand-100 hover:bg-msn-sea-900">Restaurants &amp; bars</a>
        </div>
