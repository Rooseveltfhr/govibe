...
@section('content')
    <div class="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
        <h1 class="text-3xl font-bold text-msn-ink-900 sm:text-4xl">Événements</h1>
                ...
                <a href="{{ route('evenements.show', $event->slug) }}"
                   class="block rounded-2xl border border-msn-sand-200 bg-white p-6 shadow-sm transition hover:shadow-md">
                    <div class="flex flex-wrap items-center gap-3">
                        <h2 class="font-semibold text-msn-ink-900">{{ $event->title }}</h2>
                    ...
                    <p class="mt-1 text-xs uppercase tracking-wide text-msn-ink-700/70">
