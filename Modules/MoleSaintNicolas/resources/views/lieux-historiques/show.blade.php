...
@section('content')
    <div class="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <div class="mt-6 flex flex-wrap items-center gap-3">
            <h1 class="text-3xl font-bold text-msn-sand-100 sm:text-4xl">{{ $site->name }}</h1>
        ...
        <p class="mt-6 text-msn-sand-200">{{ $site->description ?: '[Information à compléter]' }}</p>

        @if ($site->hasCoordinates())
            <div class="mt-8">
                <h2 class="mb-3 text-lg font-semibold text-msn-sand-100">Localisation</h2>
                <x-leaflet-map
        ...
        @else
            <p class="mt-8 text-sm text-msn-sand-200">[Coordonnées GPS à compléter]</p>
        @endif
