...
<div {{ $attributes->merge(['class' => 'flex flex-col items-center justify-center gap-2 border-2 border-dashed border-msn-sea-700 bg-msn-sea-900/50 text-msn-sand-200']) }}>
