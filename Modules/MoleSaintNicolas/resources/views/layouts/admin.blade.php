...
<body class="min-h-screen bg-msn-sand-100 text-msn-sea-950 font-sans antialiased">
    @auth
        <nav class="border-b border-msn-sand-200 bg-white">
            <div class="mx-auto flex max-w-5xl items-center gap-6 overflow-x-auto px-4 py-3 text-sm whitespace-nowrap sm:px-6 lg:px-8">
                ...
                <a href="{{ route('admin.histoire.events.index') }}" class="text-msn-sea-700 hover:text-msn-sea-900">Événements historiques</a>
                ...
                <a href="{{ route('admin.explorer.index') }}" class="text-msn-sea-700 hover:text-msn-sea-900">Explorer</a>
                <a href="{{ route('admin.evenements.index') }}" class="text-msn-sea-700 hover:text-msn-sea-900">Agenda</a>
                <a href="{{ route('admin.galerie.index') }}" class="text-msn-sea-700 hover:text-msn-sea-900">Galerie</a>
                ...
                <a href="{{ route('admin.messages.index') }}" class="text-msn-sea-700 hover:text-msn-sea-900">Messages</a>
