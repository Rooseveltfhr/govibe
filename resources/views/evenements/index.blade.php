...
<style>
  ...
  .ev-hero::before {
    ...
    background:radial-gradient(ellipse 55% 60% at 75% 45%,rgba(220,38,38,.14) 0%,transparent 70%);
  }
  ...
  .ev-tag {
    ...
    color:#f87171; font-size:.75rem; font-weight:700; letter-spacing:.14em;
  ...
  .ev-legend {
    ...
    color:#DC2626; padding-bottom:.5rem; margin-bottom:1.1rem;
  ...
  .ev-err { display:block; font-size:.78rem; color:#DC2626; margin-top:.3rem; }
  ...
  .ev-alert {
    ...
    background:rgba(220,38,38,.07); border:1px solid rgba(220,38,38,.28); color:#b91c1c;
  }
  ...
  .ev-group-link:hover { background:#DC2626; color:#fff; }
  ...
  <div class="ev-wrap">
    ...
    @if ($evenements->isEmpty())
      <div class="ev-closed slide-up">
        ...
        écrivez-nous à <a href="mailto:contact@govibeht.com" style="color:#DC2626;font-weight:700;">contact@govibeht.com</a>.
      </div>
    @else
