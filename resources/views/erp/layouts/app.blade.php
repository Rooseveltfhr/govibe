    ...
    <aside class="sidebar flex flex-col flex-shrink-0 h-full overflow-y-auto overflow-x-hidden"
        ...
        <nav class="flex-1 py-3 overflow-y-auto overflow-x-hidden">
            ...
            <a href="{{ route('erp.abonnements.index') }}" class="sidebar-link {{ request()->routeIs('erp.abonnements.*') ? 'active' : '' }}">
                ...
                <span class="label">
                    Abonnements
                    @if ($abonnementsImpayes > 0)
                        <span class="ml-1 text-[10px] font-bold bg-red-500 text-white rounded-full px-1.5 py-0.5">{{ $abonnementsImpayes }}</span>
                    @endif
                </span>
            </a>
            ...
            <a href="{{ route('erp.formations.index') }}" class="sidebar-link {{ request()->routeIs('erp.formations.*') ? 'active' : '' }}">
                ...
                <span class="label">
                    ...
                    @if ($inscriptionsAverifier > 0)
                        <span class="ml-1 text-[10px] font-bold bg-amber-500 text-white rounded-full px-1.5 py-0.5">{{ $inscriptionsAverifier }}</span>
                    @endif
                </span>
            </a>
